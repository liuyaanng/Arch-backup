...
this["Handlebars"]["templates"]["mtModalReact.tmpl"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;

  return "<div class=\"tw-bs mt-modal "
    + ((stack1 = ((helper = (helper = helpers.modalClass || (depth0 != null ? depth0.modalClass : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"modalClass","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\">\n    <div class=\"modal\" tabindex=\"-1\" role=\"dialog\">\n        <div class=\"modal-dialog\">\n            <div class=\"modal-content\"></div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});

this["Handlebars"]["templates"]["mtModalRequestPeoplePermissions.tmpl"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function";

  return "<div class=\"tw-bs mt-modal\">\n    <div class=\"modal mt-modal-people-perms\" tabindex=\"-1\" role=\"dialog\">\n        <div class=\"modal-dialog\">\n            <div class=\"modal-content\">\n                <div class=\"mt-modal-people-perms-background\"></div>\n                <div class=\"mt-modal-people-perms-content\">\n                    <button type=\"button\" name=\"modalDismissButton\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                        <span aria-hidden=\"true\">&times;</span>\n                    </button>\n                    <div class=\"mt-modal-people-perms-content__central\">\n                        <span class=\"mt-sprite mt-logo-icon\"></span>\n                        <h1 class=\"mt-modal-people-perms-title\">"
    + ((stack1 = ((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</h1>\n                        <h2 class=\"mt-modal-people-perms-subtitle\">"
    ...
    + "</h2>\n                        <button class=\"mt-modal-people-perms-button mt-modal-people-perms-button__cta\" name=\"openAuthWindow\">"
    + ((stack1 = ((helper = (helper = helpers.enable || (depth0 != null ? depth0.enable : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"enable","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</button>\n                        <button class=\"mt-modal-people-perms-button mt-modal-people-perms-button__cancel\" data-dismiss=\"modal\" aria-label=\"Close\">\n                            "
    + ((stack1 = ((helper = (helper = helpers.cancel || (depth0 != null ? depth0.cancel : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cancel","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n                        </button>\n                    </div>\n                </div>\n            </div>\n            <!-- /.modal-content -->\n        </div>\n        <!-- /.modal-dialog -->\n    </div>\n    <!-- /.modal -->\n</div>\n";
},"useData":true});
...
this["Handlebars"]["templates"]["mtModalTitleBodyListButton.tmpl"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"tw-bs mt-modal mt-modal-title-body-list-button\">\n    <div class=\"modal\" tabindex=\"-1\" role=\"dialog\">\n        <div class=\"modal-dialog\">\n            <div class=\"modal-content text-center\">\n                <div class=\"modal-header\">\n                    <button type=\"button\" name=\"modalDismissButton\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                        <span aria-hidden=\"true\">&times;</span>\n                    </button>\n                    <span class=\"mt-sprite mt-logo-icon\"></span>\n                    <h4 class=\"modal-title\">"
    ...
    + alias4(((helper = (helper = helpers.button || (depth0 != null ? depth0.button : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data}) : helper)))
    + "</button>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.cancelButtonText : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                </div>\n            </div>\n            <!-- /.modal-content -->\n        </div>\n        <!-- /.modal-dialog -->\n    </div>\n    <!-- /.modal -->\n</div>\n";
},"useData":true});
