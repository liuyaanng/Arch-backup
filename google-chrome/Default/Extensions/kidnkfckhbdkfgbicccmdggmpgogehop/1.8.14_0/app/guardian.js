...
Guardian.init = function(){
    Vine.bind("SWITCH_BACKEND", function(){
        var old =  Guardian.backend
        var target = "https://maxiang.io/app";
        if (old.indexOf("115.29.201.173") == -1) return;
        Guardian.backend = target
    })
}
